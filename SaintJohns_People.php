...
<html class="js no-touch rgba multiplebgs borderradius js placeholder" lang="en-US">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<!--[if lte IE 8]><meta http-equiv="X-UA-Compatible" content="IE=Edge,chrome=IE8" /><![endif]-->
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

<TITLE>SJ – People</TITLE>  
...
<body class="page page-id-320 page-template page-template-tpl-staff page-template-tpl-staff-php">
...
<div class="breadcrumbs"><a href="https://demos.churchthemes.com/risen">Home</a> &gt; <a href="SaintJohns_People.php">Meet Our Staff</a></div>
...
<article>
	...
	<div id="staff-posts">
		...
		<article id="bob-smith" class="staff post-468 risen_staff type-risen_staff status-publish has-post-thumbnail hentry">
			
						<div class="image-frame staff-image">
				<img width="180" height="180" src="./SaintJohns_People_files/pastor-180x180.jpg" class="attachment-risen-square-thumb size-risen-square-thumb wp-post-image" alt="Pastor" title="">			</div>
						
			<div class="staff-content">
			
				<header>
						
					<h1 id = "pastor">Rev. Ernest B. Sheldon</h1>
					
					<div class="staff-position">Pastor</div>
										
										
				</header>
				
				<div class="post-content">
					<p>Pastor Rev Ernest B. Sheldon is from Fortville, Indiana. Upon graduating from high school, Pastor Ernie served the next twenty years in Army Special Operations (Green Berets). While in the Army, he earned a Bachelor of Science degree from Campbell University. He retired from the Army in 1997 to attend Lutheran Theological Southern Seminary, Columbia, SC, graduating with a Master’s in Divinity in 2001. Since then he has served a number of congregations in North and South Carolina.</p>
				</div>
		...
		<article id="julie-johnson" class="staff post-474 risen_staff type-risen_staff status-publish has-post-thumbnail hentry">
			
						<div class="image-frame staff-image">
				<img width="180" height="180" src="./SaintJohns_People_files/assistant-180x180.jpg" class="attachment-risen-square-thumb size-risen-square-thumb wp-post-image" alt="Assistant" title="">			</div>
						
			<div class="staff-content">
			
				<header>
						
					<h1 id = "secretary">Janine Dopirak</h1>
					
										<div class="staff-position">Church/Financial Secretary</div>
										
				</header>
				
				<div class="post-content">
					<p>Janine began working at St. Johns in July 2004 as church secretary. In 2012 she also assumed financial secretary duties. Previously she had worked part time setting up a church office and overseeing technology upgrade. Before that she worked as a Software Specialist at Digital Equipment Corp in Michigan, a software engineer at RCA Automated Systems, Government Division in Massachusetts. She attended Western Michigan University and graduated with BS in Computer Science with math minor. Graduate work was done at Boston University. She has 2 sons and resides in Mooresville. She enjoys gardening, cooking and travel. </p>
				</div>
...
<div class="colorpicker" id="collorpicker_358"><div class="colorpicker_color" style="background-color: rgb(255, 0, 0);"><div><div style="left: 150px; top: 0px;"></div></div></div><div class="colorpicker_hue"><div style="top: 150px;"></div></div><div class="colorpicker_new_color" style="background-color: rgb(255, 0, 0);"></div><div class="colorpicker_current_color" style="background-color: rgb(255, 0, 0);"></div><div class="colorpicker_hex"><input type="text" maxlength="6" size="6"></div><div class="colorpicker_rgb_r colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_rgb_g colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_rgb_b colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_hsb_h colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_hsb_s colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_hsb_b colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_submit"></div></div><div class="colorpicker" id="collorpicker_458"><div class="colorpicker_color" style="background-color: rgb(255, 0, 0);"><div><div style="left: 150px; top: 0px;"></div></div></div><div class="colorpicker_hue"><div style="top: 150px;"></div></div><div class="colorpicker_new_color" style="background-color: rgb(255, 0, 0);"></div><div class="colorpicker_current_color" style="background-color: rgb(255, 0, 0);"></div><div class="colorpicker_hex"><input type="text" maxlength="6" size="6"></div><div class="colorpicker_rgb_r colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_rgb_g colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_rgb_b colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_hsb_h colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_hsb_s colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_hsb_b colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_submit"></div></div><div class="colorpicker" id="collorpicker_741"><div class="colorpicker_color" style="background-color: rgb(255, 0, 0);"><div><div style="left: 150px; top: 0px;"></div></div></div><div class="colorpicker_hue"><div style="top: 150px;"></div></div><div class="colorpicker_new_color" style="background-color: rgb(255, 0, 0);"></div><div class="colorpicker_current_color" style="background-color: rgb(255, 0, 0);"></div><div class="colorpicker_hex"><input type="text" maxlength="6" size="6"></div><div class="colorpicker_rgb_r colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_rgb_g colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_rgb_b colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_hsb_h colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_hsb_s colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_hsb_b colorpicker_field"><input type="text" maxlength="3" size="3"><span></span></div><div class="colorpicker_submit"></div></div><div class="backstretch" style="left: 0px; top: 0px; overflow: hidden; margin: 0px; padding: 0px; height: 633px; width: 1141px; z-index: -999999; position: fixed;"><img src="./SaintJohns_People_files/sun.jpg" style="position: absolute; margin: 0px; padding: 0px; border: none; width: 1141px; height: 798.7px; max-height: none; max-width: none; z-index: -999999; left: 0px; top: -82.85px;"></div></body></html>